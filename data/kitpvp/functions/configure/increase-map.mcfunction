execute unless score map settings matches 11 run scoreboard players add map settings 1
...
execute if score map settings matches 11 run tellraw @a {"text":"Map 11 - KitPvP Classic selected. (Massive x 4)", "color":"gold"}
