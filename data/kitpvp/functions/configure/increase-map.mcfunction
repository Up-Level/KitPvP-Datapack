execute unless score map settings matches 8 run scoreboard players add map settings 1
...
execute if score map settings matches 8 run tellraw @a {"text":"Map 8 - Gulag selected. (Medium)", "color":"gold"}