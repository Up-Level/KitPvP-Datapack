...
execute if score gamemode-running settings matches 1 if score map settings matches 2 at @e[name=spawn] run spreadplayers -87 -3016 30 50 false @a[scores={optIn=1},distance=..50]
