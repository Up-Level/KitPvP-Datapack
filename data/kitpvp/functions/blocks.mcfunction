...
execute as @e[scores={Dummy=0},tag=block,type=!minecraft:armor_stand] at @s run particle minecraft:block minecraft:cobblestone ~ ~.5 ~ 0.25 0.25 0.25 0.025 50 force
