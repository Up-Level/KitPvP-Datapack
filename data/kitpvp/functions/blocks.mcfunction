...
execute as @e[tag=newBlock,type=!minecraft:armor_stand] at @s run playsound minecraft:block.stone.place block @a ~ ~ ~ 1 1
...
execute as @e[scores={Dummy=0},tag=block,type=!minecraft:armor_stand] at @s run playsound minecraft:block.stone.break block @a ~ ~ ~ 1 1
