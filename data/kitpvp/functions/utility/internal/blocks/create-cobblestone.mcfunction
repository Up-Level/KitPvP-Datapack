...
summon minecraft:armor_stand 0 20 2000 {Tags:["newBlock","temp","main"],Invisible:1,NoGravity:1,Marker:1b,Passengers:[{id:"falling_block",BlockState:{Name:"minecraft:cobblestone"},Data:0,Time:1,NoAI:1b,DropItem:0,Tags:["newBlock","temp"],NoGravity:1b,Glowing:0b}]}
