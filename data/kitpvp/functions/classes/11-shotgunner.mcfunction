...
execute as @s run execute unless entity @s[nbt={Inventory:[{id:"minecraft:firework"}]}] run replaceitem entity @s weapon.offhand firework_rocket{Fireworks:{Flight:-1,Explosions:[{Type:0,Flicker:0,Trail:0,Colors:[I;14602026,15435844],FadeColors:[I;11743532]}]}} 1
