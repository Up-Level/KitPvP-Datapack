...
execute unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick"}]}] if entity @s[scores={pathCharges=1..}] run replaceitem entity @s hotbar.1 minecraft:carrot_on_a_stick{CustomModelData:1,Unbreakable:1b,display:{Name:'[{"text":"Create Boat","italic":false}]',Lore:['[{"text":"Creates a path of stone for you to climb..","italic":false,"color":"gray"}]']}}
execute unless entity @s[nbt={Inventory:[{id:"minecraft:warped_fungus_on_a_stick"}]}] run replaceitem entity @s hotbar.2 minecraft:warped_fungus_on_a_stick{CustomModelData:1,Unbreakable:1b,display:{Name:'[{"text":"Destroy Boat","italic":false}]',Lore:['[{"text":"Destory your previous boat.","italic":false,"color":"gray"}]']}}
...
execute if entity @s[scores={fungusStickBin=1}] at @s positioned ~ ~1 ~ positioned ^1 ^1 ^3 run function kitpvp:utility/internal/blocks/create-cobblestone
execute if entity @s[scores={fungusStickBin=1}] at @s positioned ~ ~1 ~ positioned ^0 ^1 ^3 run function kitpvp:utility/internal/blocks/create-cobblestone
execute if entity @s[scores={fungusStickBin=1}] at @s positioned ~ ~1 ~ positioned ^-1 ^1 ^3 run function kitpvp:utility/internal/blocks/create-cobblestone
execute if entity @s[scores={fungusStickBin=1}] at @s positioned ~ ~1 ~ positioned ^1 ^0 ^3 run function kitpvp:utility/internal/blocks/create-cobblestone
execute if entity @s[scores={fungusStickBin=1}] at @s positioned ~ ~1 ~ positioned ^0 ^0 ^3 run function kitpvp:utility/internal/blocks/create-cobblestone
execute if entity @s[scores={fungusStickBin=1}] at @s positioned ~ ~1 ~ positioned ^-1 ^0 ^3 run function kitpvp:utility/internal/blocks/create-cobblestone
execute if entity @s[scores={fungusStickBin=1}] at @s positioned ~ ~1 ~ positioned ^1 ^-1 ^3 run function kitpvp:utility/internal/blocks/create-cobblestone
execute if entity @s[scores={fungusStickBin=1}] at @s positioned ~ ~1 ~ positioned ^0 ^-1 ^3 run function kitpvp:utility/internal/blocks/create-cobblestone
execute if entity @s[scores={fungusStickBin=1}] at @s positioned ~ ~1 ~ positioned ^-1 ^-1 ^3 run function kitpvp:utility/internal/blocks/create-cobblestone
