...
execute unless entity @s[nbt={Inventory:[{id:"shield"}]}] run replaceitem entity @s weapon.offhand minecraft:shield{Unbreakable:1b,display:{Name:'[{"text":"Dinner Plate","italic":false}]',Lore:['[{"text":"Supposedly...","italic":false,"color":"gray"}]']}}
