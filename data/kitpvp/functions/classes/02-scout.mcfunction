...
execute as @s run execute unless entity @s[nbt={Inventory:[{id:"minecraft:bow"}]}] run replaceitem entity @s hotbar.1 bow{Unbreakable:1b,Enchantments:[{id:"minecraft:infinity",lvl:1}]}
