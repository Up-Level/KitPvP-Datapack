...
execute unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick"}]}] if entity @s[scores={pathCharges=1}] run replaceitem entity @s hotbar.1 minecraft:carrot_on_a_stick{CustomModelData:2,Unbreakable:1b,display:{Name:'[{"text":"Create Path (1)","italic":false}]',Lore:['[{"text":"Creates a path of stone for you to climb.","italic":false,"color":"gray"}]']}}
execute unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick"}]}] if entity @s[scores={pathCharges=2}] run replaceitem entity @s hotbar.1 minecraft:carrot_on_a_stick{CustomModelData:3,Unbreakable:1b,display:{Name:'[{"text":"Create Path (2)","italic":false}]',Lore:['[{"text":"Creates a path of stone for you to climb.","italic":false,"color":"gray"}]']}}
execute unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick"}]}] if entity @s[scores={pathCharges=3}] run replaceitem entity @s hotbar.1 minecraft:carrot_on_a_stick{CustomModelData:4,Unbreakable:1b,display:{Name:'[{"text":"Create Path (3)","italic":false}]',Lore:['[{"text":"Creates a path of stone for you to climb.","italic":false,"color":"gray"}]']}}
execute unless entity @s[nbt={Inventory:[{id:"minecraft:carrot_on_a_stick"}]}] if entity @s[scores={pathCharges=4..}] run replaceitem entity @s hotbar.1 minecraft:carrot_on_a_stick{CustomModelData:4,Unbreakable:1b,display:{Name:'[{"text":"Create Path (3+)","italic":false}]',Lore:['[{"text":"Creates a path of stone for you to climb.","italic":false,"color":"gray"}]']}}
