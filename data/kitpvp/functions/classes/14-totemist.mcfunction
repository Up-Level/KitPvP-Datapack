...
execute if score @s dmgDealtAlive matches 400.. run scoreboard players add @s classMode 1
execute if score @s dmgDealtAlive matches 400.. run scoreboard players set @s dmgDealtAlive 0
