...
execute unless entity @s[nbt={Inventory:[{id:"minecraft:iron_shovel"}]}] run replaceitem entity @s hotbar.1 minecraft:iron_shovel{Unbreakable:1b,display:{Name:'{"text":"Spoon"}'}}
