...
execute as @s[scores={killsSinceDeath=1..}] run effect give @s resistance 1 0 true
execute as @s[scores={killsSinceDeath=2..}] run effect give @s strength 1 0 true
execute as @s[scores={killsSinceDeath=3..}] run effect give @s resistance 1 2 true
execute as @s[scores={killsSinceDeath=4..}] run effect give @s strength 1 2 true
