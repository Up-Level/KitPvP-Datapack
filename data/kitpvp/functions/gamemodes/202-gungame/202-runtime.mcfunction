...
execute as @a[scores={optIn=1,class=24..}] run scoreboard players set @s class 23
...
execute as @a[scores={optIn=1}] run title @s actionbar [{"text":"You are class ","color":"gold"},{"score":{"name":"@s","objective":"gm_sidebar"}},"/22"]
