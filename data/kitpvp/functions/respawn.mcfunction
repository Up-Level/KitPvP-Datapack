...
execute as @a[scores={respawnTimer=..0},team=none] run function kitpvp:utility/internal/solo-map-tp
execute as @a[scores={respawnTimer=..0},team=!none] run function kitpvp:utility/internal/teams-map-tp
