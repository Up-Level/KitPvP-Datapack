...
scoreboard players set #362880 const 362880
scoreboard players set #1200000 const 1200000

scoreboard objectives remove const_S100
scoreboard objectives add const_S100 dummy
scoreboard players set #pi const_S100 314

scoreboard objectives remove mData
