...
execute store result score inp3 mIO as @e[tag=entity1,limit=1] run data get entity @s Pos[0] 100
execute store result score inp4 mIO as @e[tag=entity1,limit=1] run data get entity @s Pos[1] 100
execute store result score inp5 mIO as @e[tag=entity1,limit=1] run data get entity @s Pos[2] 100
